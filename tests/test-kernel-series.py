...
check("预发布与补丁后缀仍归入主次版本目录",
      all(ks.series_of(v) == "7.1" for v in
          ("7.1_rc1", "7.1_p2", "7.1.7-r1")))
...
check("预发布、正式版、补丁版与修订号按 Portage 语义排序",
      [v for _, v in pairs(["7.1_p1", "7.1.1-r1", "7.1_rc1", "7.1.1"])]
      == ["7.1_rc1", "7.1_p1", "7.1.1", "7.1.1-r1"],
      str(pairs(["7.1_p1", "7.1.1-r1", "7.1_rc1", "7.1.1"])))
